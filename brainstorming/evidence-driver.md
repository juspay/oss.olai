...
*(Tamil சாட்சி: witness, evidence. github.com/juspay/saatchi; local clone ~/code/saatchi.)*
...
## .saatchi/mod.just — the adapter, whole (olai's)
...
saatchi is born in its own repo. olai consumes it by scaffolding .saatchi/
and deleting its per-lane plumbing; briefs shrink to: "Evidence via
`nix run github:juspay/saatchi`; section inline in the PR body beside its shots."
