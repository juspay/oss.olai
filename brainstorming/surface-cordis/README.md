...
[Fable’s September 11 review](fable-sep11-review.md) checks the configuration/search delta. The synthesis incorporates its lifecycle findings while keeping persistence/recovery policy app-owned and new owner-scoped policy APIs explicitly provisional. Current architecture references: [plugin system](https://github.com/juspay/olai/blob/5e087668e799be256161643648bda1a3a67e3ebc/docs/architecture/plugin-system.md), [Cordis](https://github.com/juspay/olai/blob/5e087668e799be256161643648bda1a3a67e3ebc/docs/architecture/cordis.md), [location ownership](https://github.com/juspay/olai/blob/5e087668e799be256161643648bda1a3a67e3ebc/docs/architecture/slot-ownership.md).

[Two-PR delivery review](fable-delivery-review.md): phases stay inside the same Kolu/Olai drafts; the consumer closure and pin checks are phase-one deliverables, tested pairs are recorded in PR bodies, and post-merge Olai repinning/validation precedes the human’s second merge.
