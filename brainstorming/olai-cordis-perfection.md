...
4. **Review until both reviewers are satisfied.** Astra coordinates with Fable (currently `755915a7-80ce-4bbc-9eb1-35e8c4a49bfb`; verify the terminal before dispatch). Both leave attributed findings on the PR and notify the implementor to address them. The implementor pushes fixes and contacts Astra again. Repeat until both explicitly accept the same commit.
